...
<div class="container">
    <div class="main">
        <div>
            <h3>Birthday Information (Active)</h3>
            <br>
        </div>
        ...
        <ul class="additional_buttons">
            <li>
                <button type="button" class="btn btn-warning" value="" id="trashMultiple"
                        name="trashMultiple"><span class="glyphicon glyphicon-trash"></span> Trash Multiple
                </button>
            </li>
            <li>
            ...
            <li style="float: right">
                <form action="index.php" method="get" id="searchForm">
                    <div>
                        ...
                        <input type="checkbox" name="byBirthday" id="byBirthday" checked> By Birthday
        ...
        <ul class="bottom_right">
            <li>
                <a href="trashed.php">
                    <button class="btn btn-info">Trash List</button>
                </a>
            </li>
            <li>
                <a href="create.php">
