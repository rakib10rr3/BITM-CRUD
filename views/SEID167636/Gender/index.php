...
if (isset($_REQUEST['search'])) {
    $someData = $objGender->search($_REQUEST);
}
$availableKeywords = $objGender->getAllKeywords();
...
$someData = $objGender->indexPaginator($page, $itemsPerPage);
$allData = $someData;
...
<div class="container">
    <div class="main">
        <div>
            <h3>Gender Information (Active)</h3>
            <br>
        </div>
            ...
            <li style="float: right">
                <form action="index.php" method="get" id="searchForm">
                    <div>
                        ...
                        <input type="checkbox" name="byGender" id="byGender" checked> By Gender
            ...
            <table class="table table-bordered table-striped text-center">
                ...
                foreach ($allData as $record) { ?>
                    <tr>
                        ...
                        <td width="15%"><?php echo $record->gender; ?></td>
                        <td width="45%">
