...
$allData = $objOrganization->trashed();
?>
...
<div class="container">
    <div class="main">
        <div>
            <h3>Organization Information (Trashed)</h3>
            <br>
        </div>
        <table class="table table-bordered table-striped text-center">
            ...
            foreach ($allData as $record) { ?>
                <tr>
                    ...
                    <td width="15%"><?php echo $record->organization_name; ?></td>
                    <td width="20%"><?php echo $record->organization_summary; ?></td>
                    <td width="30%">
