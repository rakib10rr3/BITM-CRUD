...
$allData = $objOrganization->index();


################## search  block 1 of 5 start ##################
if (isset($_REQUEST['search'])) {
    $someData = $objOrganization->search($_REQUEST);
}

$availableKeywords = $objOrganization->getAllKeywords();
...
$someData = $objOrganization->indexPaginator($page, $itemsPerPage);
$allData = $someData;
...
<div class="container">
    <div class="main">
        <div>
            <h3>Organization Information (Active)</h3>
            <br>
        </div>
            ...
            <li style="float: right">
                <form action="index.php" method="get" id="searchForm">
                    <div>
                        ...
                        <input type="checkbox" name="byOrganization" id="byOrganization" checked> By Organization
            ...
            <table class="table table-bordered table-striped text-center">
                ...
                foreach ($allData as $record) { ?>
                    <tr>
                        ...
                        <td width="10%"><?php echo $record->name; ?></td>
                        <td width="10%"><?php echo $record->organization_name; ?></td>
                        <td width="25%"><?php echo $record->organization_summary; ?></td>
                        <td width="55%">
