...
<div class="container">
    <div class="main">
        <div>
            <h3>Book Title Information (Active)</h3>
            <br>
        </div>
            ...
            <li style="float: right">
                <form action="index.php" method="get" id="searchForm">
                    <div>
                        ...
                        <input type="checkbox" name="byTitle" id="byTitle" checked> By Title
                        <input type="checkbox" name="byAuthor" id="byAuthor" checked> By Author
            ...
            <table class="table table-bordered table-striped text-center">
                ...
                foreach ($allData as $record) { ?>
                    <tr>
                        ...
                        <td width="15%"><?php echo $record->book_title ?></td>
                        <td width="15%"><?php echo $record->author_name; ?></td>
                        <td width="45%">
