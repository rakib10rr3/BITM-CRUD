...
<div class="container">
    <div class="main">
        <div>
            <h3>Profile Picture Information (Active)</h3>
            <br>
        </div>
            ...
            <li style="float: right">
                <form action="index.php" method="get" id="searchForm">
                    <div>
                        ...
                        <input type="checkbox" name="byPicture" id="byPicture" checked> By Picture
            ...
            <table class="table table-bordered table-striped text-center">
                ...
                foreach ($allData as $record) { ?>
                    <tr>
                        ...
                        <td width="10%"><img height="150px" width="120" src="images/<?php echo $record->profile_picture;?>"></td>
                        <td width="40%">
