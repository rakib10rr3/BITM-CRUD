...
<div class="container">
    <div class="main">
        ...
        <div class="formInfo">
            <h3 align="center">Profile Picture Information</h3>
            <form action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="currentProfilePicture">Profile Picture</label>
                    <br>
                    <img style="margin-left: 80px;height: 700px;width: 500px" src="images/<?php echo $singleData->profile_picture;?>">
                </div>
